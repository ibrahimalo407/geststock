...
<div class="container mx-auto p-6">
    ...
    <a href="{{ route('orders.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 flex items-center">
        ...
        <table class="min-w-full bg-white shadow-md rounded-lg">
            <thead>
                <tr class="bg-gray-100 border-b border-gray-200">
                    ...
                    <th class="py-3 px-4 text-left text-sm font-medium text-gray-700">Created At</th>
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-200">
                    ...
                    <td class="px-4 py-2 flex space-x-2 items-center">
                        ...
                        <a href="{{ route('orders.edit', $order) }}" class="text-yellow-500 hover:text-yellow-600">
